...
CREATE TABLE IF NOT EXISTS orders (
    ...
    order_status ENUM('pending', 'confirmed', 'preparing', 'shipped', 'delivered', 'cancelled', 'refunded') NOT NULL DEFAULT 'pending',
...
CREATE TABLE IF NOT EXISTS shipments (
    ...
    shipment_status ENUM('not_shipped', 'shipped', 'in_transit', 'delivered', 'cancelled') NOT NULL DEFAULT 'not_shipped',
